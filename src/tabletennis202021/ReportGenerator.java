...
public class ReportGenerator 
{
    ...
    public String returnTeamStats1() 
    {   //to delete if upper works
        String stats = "";
        for (TeamStats t : tstats) 
        {
            stats += t.toString();
    ...
    {
        JDialog dialog = null;//add components to it
        JOptionPane optionPane = new JOptionPane();//used to provide standard dialog box such 
        optionPane.setMessage("Fixtures and results");//display the message
